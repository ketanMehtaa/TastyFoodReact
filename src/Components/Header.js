    ...
    <>
      <div>
        {locationSearchisVisisble && (
          <LocationSearch childState={locationSearchisVisisble} setChildState={setLocationSearchisVisisble} />
        )}
      </div>
      <div
      ...
      >
        <div className="max-w-[25%] flex items-center gap-2 ">
          ...
          <div className="flex truncate cursor-pointer self-center" onClick={() => handleLocationClick()}>
            <h2
            ...
            >
              ...
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    viewBox="5 -1 12 25"
                    className={`w-[17px] h-[17px] ${isActive('/search') ? 'fill-orange' : 'fill-[#686b78]'}`}
                  >
            ...
            >
              ...
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    viewBox="6 -1 12 25"
                    className={`w-[18px] h-[19px] ${isActive('/help') ? 'fill-orange' : 'fill-[#686b78]'}`}
                  >
            ...
            >
              ...
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    viewBox="6 0 12 24"
                    className={`w-[18px] h-[19px] ${isActive('/profile') ? 'fill-orange' : 'fill-[#686b78]'}`}
                  >
                      ...
                      <span className="relative top-1/2">
                        <svg
                          className={`stroke-2 overflow-hidden ${
                            isActive('/cart') ? 'fill-orange stroke-orange' : 'fill-[#60b246] stroke-[#60b246]'
                          }`}
                          viewBox="-1 0 37 32"
                          height="20"
                          width="20"
