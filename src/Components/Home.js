  ...
  return resList?.length === 0 ? (
    ...
    <>
      {notServicable !== undefined ? (
        ...
        <div className="xl:max-w-[80%] lg:max-w-[80%] md:max-w-[90%] sm:max-w-[90%] mx-auto min-h-screen pt-24">
          {topicalBanner && (
            <>
              <div className="flex justify-between mt-6 ml-4 pl-2 items-center">
                <h1 className="text-2xl h-fit leading-5 tracking-tighter font-extrabold">Best Offers for you</h1>
              ...
              <div className="topicalBanner container-snap flex overflow-x-auto">
                {topicalBanner.map((img) => {
                  return (
                    <div className="ml-6 mt-8 cursor-pointer flex-shrink-0" key={img.imageId}>
          ...
          {wOYM && (
            <>
              <div className="flex justify-between mt-8 ml-4 pl-2 items-center">
                <h1 className="text-2xl h-fit leading-5 tracking-tighter font-extrabold">What's on your mind?</h1>
                ...
                >
                  <h1
                    className={`text-center flex-1 text-base tracking-tight font-medium whitespace-nowrap ${
                      sortActive !== undefined ? 'text-orange' : 'text-[#050e1bbf]'
                    }`}
                  >
          ...
          {bestPlaces && (
            <>
              ...
              <div className="flex flex-wrap gap-x-2 justify-between my-8">
                ...
                >
                  Show more &nbsp;
                  <FontAwesomeIcon icon={faChevronDown} className={bestPlacesOpen ? 'rotate-180' : ''} />
                </div>
                {bestPlacesOpen &&
          ...
          {bestCuiNearMe && (
            <>
              <div className="mt-16 ml-4 pl-2">
                <h1 className="text-2xl h-fit leading-5 tracking-tighter font-extrabold">Best Cuisines Near Me</h1>
              </div>
              <div className="flex flex-wrap gap-x-2 justify-between my-8">
                ...
                >
                  Show more &nbsp;
                  <FontAwesomeIcon icon={faChevronDown} className={bestCuiOpen ? 'rotate-180' : ''} />
                </div>
                {bestCuiOpen &&
      ...
      <div className="">
        ...
        <div className="flex bg-[#02060C] text-[#ffffff99] flex-col items-center justify-center p-10">
          <div className="grid grid-cols-4 gap-x-[5%] w-[85%] mx-auto">
            ...
            <div className="col-start-4 row-start-1">
              ...
              >
                <h1 className="p-1 h-fit truncate">{footerCities?.slice(6).length} cities &nbsp;</h1>
        ...
        >
          <h2 className="pb-6 font-bold text-lg text-white w-[80%] tracking-tight">Other cities that we deliver:</h2>
